...
/**
 * "Continue with Google" — kicks off the allauth headless provider redirect
 * (see `providerRedirect`). Renders only when Google is actually configured on
 * the backend, so it never shows a button that 404s/errors before credentials
